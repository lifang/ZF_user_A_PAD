package com.example.zf_pad.alipay;
...
public abstract class RepairPayActivity extends Activity {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case SDK_CHECK_FLAG: {
				Toast.makeText(RepairPayActivity.this, "检查结果为：" + msg.obj,
	...
	public void pay(String outTradeNo, String subject, String body, String price) {
		// 订单
		String orderInfo = getOrderInfo(outTradeNo, subject, body, price);
		...
		Runnable payRunnable = new Runnable() {
			...
			public void run() {
				// 构造PayTask 对象
				PayTask alipay = new PayTask(RepairPayActivity.this);
				// 调用支付接口，获取支付结果
	...
	public void check(View v) {
		Runnable checkRunnable = new Runnable() {
			...
			public void run() {
				// 构造PayTask 对象
				PayTask payTask = new PayTask(RepairPayActivity.this);
				// 调用查询接口，获取查询结果
	...
	private String getOrderInfo(String outTradeNo, String subject, String body, String price) {
		...
		// 服务器异步通知页面路径
		orderInfo += "&notify_url=" + "\"" + Config.REPAIR_NOTIFT_URL + "\"";
		...
		orderInfo += "&return_url=\"" + Config.RETURN_URL + "\"";
