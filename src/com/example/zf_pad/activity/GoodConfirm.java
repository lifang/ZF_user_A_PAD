							...
							if(a==Config.CODE){  
 								...
 								for(int i =0;i<moreList.size();i++){
 									...
 									/*	addressId=moreList.get(i).getId();
 										tv_adress.setText("鏀朵欢鍦板潃 锛? "+moreList.get(i).getAddress());
 										tv_sjr.setText("鏀朵欢浜? 锛? "+moreList.get(i).getReceiver());
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode==11){
			if(data!=null){
				...
				tv_adress.setText("鏀朵欢鍦板潃 锛? "+data.getStringExtra("adree"));
				tv_sjr.setText("鏀朵欢浜? 锛? "+data.getStringExtra("name"));
		...
		API.GOODCONFIRM(GoodConfirm.this,80,goodId,paychannelId,
                ...
                new HttpCallback  (GoodConfirm.this) {
					...
					public void onSuccess(Object data) {
						Toast.makeText(getApplicationContext(), "创建订单成功", 1000).show();
