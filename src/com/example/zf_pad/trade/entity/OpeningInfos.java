...
public class OpeningInfos {
	...
	public int getPreliminary_verify_user_id() {
		return preliminary_verify_user_id;
	}
	public void setPreliminary_verify_user_id(int preliminary_verify_user_id) {
		this.preliminary_verify_user_id = preliminary_verify_user_id;
	}
	...
	public int getBilling_cyde_id() {
		return billing_cyde_id;
	}
	public void setBilling_cyde_id(int billing_cyde_id) {
		this.billing_cyde_id = billing_cyde_id;
	}
	...
	public void setApply_customer_id(int apply_customer_id) {
	...
	private int preliminary_verify_user_id;
