...
import com.example.zf_pad.trade.entity.AfterSaleDetail;
import com.example.zf_pad.trade.entity.AfterSaleDetailCancel;
import com.example.zf_pad.trade.entity.AfterSaleDetailChange;
import com.example.zf_pad.trade.entity.AfterSaleDetailLease;
import com.example.zf_pad.trade.entity.AfterSaleDetailMaintain;
import com.example.zf_pad.trade.entity.AfterSaleDetailReturn;
import com.example.zf_pad.trade.entity.AfterSaleDetailUpdate;
import com.example.zf_pad.trade.entity.Comment;
import com.example.zf_pad.trade.entity.ResourceInfo;
		...
		API.getAfterSaleRecordDetail(this, mRecordType, mRecordId, new HttpCallback<AfterSaleDetail>(this) {
			...
			public void onSuccess(AfterSaleDetail data) {
				...
				if (mRecordType == LEASE) {
					...
					terminalPairs.put(terminalKeys[8], lease.getLeaseLength() + getString(R.string.notation_month));
					terminalPairs.put(terminalKeys[9], lease.getLeaseMaxTime() + getString(R.string.notation_month));
					terminalPairs.put(terminalKeys[10], lease.getLeaseMinTime() + getString(R.string.notation_month));
				}
